	...
	$(function() {
		...
		$("#nameCheck").on("click", function() {
			if(nameReg.exec($("#name").val())){
				$.ajax({
					type: "POST",
					url: "${pageContext.request.contextPath}/memberNameCheck",
					data: {
						"name": $("#name").val()
						},
					success: function(res) {
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4>회원정보수정</h4>
              <form action='memberUpdatePro?num=${param.num}' class="pt-3" method="Post" onsubmit="return checkForm();">
              닉네임
                ...
                <div class="text-center mt-4 font-weight-light">
                   <a href="main" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">취소</a>
                </div>
              </form>
            </div>
          </div>
